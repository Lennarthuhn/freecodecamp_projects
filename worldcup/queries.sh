...
echo "$($PSQL "SELECT name FROM games INNER JOIN teams ON winner_id=team_id WHERE round='Eighth-Final' AND year= 2014 UNION SELECT name FROM games INNER JOIN teams ON opponent_id=team_id WHERE round='Eighth-Final' AND year= 2014 ORDER BY name")"
